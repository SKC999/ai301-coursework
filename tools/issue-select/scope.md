...
I'm a CS and Data Science graduate building apps to solve everyday problems.
I work in Python and want to grow my skills in React and Node.js for app development,
and in R for dataset building and data science contributions. I'm looking for issues
that let me practice real problem-solving in these areas—not niche or overly specialized
domains, and nothing that's docs-only.
